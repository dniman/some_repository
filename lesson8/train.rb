...
class Train
  ...
  # метод, который принимает блок и проходит
  # по всем вагонам поезда (вагоны должны быть во внутреннем массиве),
  ...
  def validate!
    ...
    raise 'Номер поезда не соответствует формату!' unless matched_number?
  end
